...
function About() {
  ...
  return (
    ...
    transition={{ duration: 1 }}>
      <section id='about' className='bg-about-mobile sm:bg-about-tablet lg:bg-about-desktop  flex justify-center items-center  h-[20vh] lg:h-[30vh] md:justify-between md:px-10 lg:px-[9rem]'>
      ...
      <section className='container xl:w-11/12 mx-auto lg:px-6 relative '>
        ...
        <div className='w-full lg:mt-10'>
          ...
          <p data-aos="fade-up" data-aos-duration="1500" className='w-9/12 mx-auto text-center text-darkGray font-mono lg:text-left lg:mx-0 lg:w-3/4 py-7 lg:text-xl'>Getting around should be simple (and even fun!) for everyone. We embrace technology to provide low cost, smart access to scooters at your fingertips.</p>
        </div>
        ...
        <div className='w-full'>
          ...
          lg:text-xl'>We’re helping connect cities and bring people closer together. Our scooters are also fully-electric and we offset the minimal carbon footprint for each ride.</p>
        </div>
        </article>
        </div>
      </section>
        ...
        <div className='pt-10 lg:flex lg:gap-10 lg:justify-evenly mx-auto'>
          <article className='flex flex-col justify-center relative'>
            ...
            <span className="circle1 flex items-center justify-center">
              ...
              <h2 data-aos="fade-up" data-aos-duration="1000" className='font-mono text-2xl font-bold text-darkGray w-1/2 mx-auto mt-16  pb-3 text-center lg:w-full lg:text-3xl'>Our tech</h2>
          ...
          <article className='flex flex-col justify-center my-10  relative '>
            <img data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="300" src={intergrity} alt="our intergrity" className='rounded-full h-[15rem] lg:h-[18rem] mx-auto'/>
            <span className="circle2 flex items-center justify-center">
                <p className='font-mono font-bold text-darkGray text-xl'>02</p>
            </span>
              <h2 data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300" className='font-mono text-2xl font-bold text-darkGray w-1/2 mx-auto mt-14 pb-3 text-center lg:w-full lg:text-3xl'>Our integrity</h2>
          ...
          <article className='flex justify-center flex-col relative'>
            <img data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="500" src={community} alt="community" className='rounded-full h-[15rem] lg:h-[18rem] mx-auto'/>
            <span className="circle3 flex items-center justify-center">
                <p className='font-mono font-bold text-darkGray text-xl'>03</p>
            </span>
              <h2 data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500" className='font-mono text-2xl font-bold text-darkGray w-1/2 mx-auto mt-14 pb-3 text-center lg:w-full lg:text-3xl'>Our community</h2>
